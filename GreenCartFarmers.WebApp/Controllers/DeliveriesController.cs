...
namespace GreenCartFarmers.WebApp.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DeliveryId,OrderId,DeliveryDate,DeliveryStatus")] Delivery delivery)
        {
            ...
            ViewBag.OrderId = new SelectList(db.Orders, "OrderId", "Status", delivery.OrderId);
            return View(delivery);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DeliveryId,OrderId,DeliveryDate,DeliveryStatus")] Delivery delivery)
        {
            if (ModelState.IsValid)
            {
